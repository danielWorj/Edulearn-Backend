...
//            cni.transferTo(path);
    ...
    public ResponseEntity<List<Parent>> allParent() {
        return ResponseEntity.ok(this.parentRepository.findAll(Sort.by(Sort.Direction.DESC, "id")));
    }

    @Override
    public ResponseEntity<Parent> findParentById(Integer id) {
        return ResponseEntity.ok(this.parentRepository.findById(id).orElse(null));
    }
    ...
    @Override
    public ResponseEntity<ServerResponse> deleteParent(Integer id) {
        this.parentRepository.deleteById(id);
        return  ResponseEntity.ok(new ServerResponse("Delete Parent : true", true));
    }
